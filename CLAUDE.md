...
| `copilot-review.yml` | Required merge gate: waits until Copilot's latest review of HEAD recommends merge. Retriggers on `ready_for_review` and review submit/edit/dismiss. Open threads stay a conversation-resolution rule, not this waiter's timeout. See #119 |
